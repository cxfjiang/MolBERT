...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, positional_enc, token_type_ids=None):
        ...
        #print(words_embeddings.shape, positional_enc.shape, token_type_embeddings.shape)
...
class BertLMPredictionHead(nn.Module):
    def __init__(self, config, bert_model_embedding_weights):
        ...
        # The output_model weights are the same as the input embeddings, but there is
        # an output_model-only bias for each token.
