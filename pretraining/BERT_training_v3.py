...
import sys
sys.path.append("../")
from dataset.load_traning import BERTDataset
...
config["word2idx_path"] = "../croups/ident_merge.pickle"
config["output_path"] = "../output_model"  # 模型输出位置
config["vocab_size"] = 64711
config["batch_size"] = 4
...
config["model_out_path"] = config["output_path"] + "/" + "middle_hidden_" + str(config["hidden_size"]) \
